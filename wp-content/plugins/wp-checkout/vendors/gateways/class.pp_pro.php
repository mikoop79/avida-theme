...
class wpcopp_pro extends wpCheckoutPlugin {
	public $API_USERNAME;
	public $API_PASSWORD;
	...
	function __construct($API_USERNAME, $API_PASSWORD, $API_SIGNATURE, $PROXY_HOST, $PROXY_PORT, $IS_ONLINE = FALSE, $USE_PROXY = FALSE, $VERSION = '57.0', $api_endpoint = null) {
