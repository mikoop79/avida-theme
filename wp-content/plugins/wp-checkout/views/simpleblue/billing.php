...
<?php if ($user_ID || $this -> get_option('guestcheckout') == "Y") : ?>
    ...
    <form <?php if ($this -> is_plugin_active('euvatex')) : ?>onsubmit="jQuery.Watermark.HideAll();"<?php endif; ?> action="<?php echo $wpcoHtml -> bill_url(); ?>" method="post" id="<?php echo $this -> pre; ?>billingform">
        ...
        <?php if (!empty($paymentmethods)) : ?>        
            ...
            <?php else : ?>
                <fieldset class="wpco steps paymentmethod">
                    <legend><?php _e('Payment Method', $this -> plugin_name); ?></legend>
            ...
            <div id="<?php echo $this -> pre; ?>bwdetails" style="display:<?php echo (!empty($user -> bill_pmethod) && $user -> bill_pmethod == "bw") ? 'block' : 'none'; ?>">
                ...
                <fieldset class="wpco steps bankingdetails">
            ...
            <div id="<?php echo $this -> pre; ?>ccdetails" style="display:<?php echo (!empty($user -> bill_pmethod) && $user -> bill_pmethod == "cc") ? 'block' : 'none'; ?>;">				
                ...
                <fieldset class="wpco steps ccdetails">
                    <legend><?php _e('Credit Card Details', $this -> plugin_name); ?></legend>
       				<div class="stepsholder">
                        <table class="wpco_billing <?php echo $this -> pre; ?>">
                            <tbody>
                                <?php $class = ''; ?>
        ...
        <?php endif; ?>
            <fieldset class="wpco steps billinginfo">
                <legend><?php _e('Billing Information', $this -> plugin_name); ?></legend>
       			<div class="stepsholder"> 
                    <table class="wpco_billing <?php echo $this -> pre; ?>">
                        <tbody>
                            <?php $class = ''; ?>
                                    ...
                                    <?php if ($bkey == "country") : ?>
                                        <tr class="<?php echo $class = (empty($class) || $class == "erow") ? 'arow' : 'erow'; ?>">
                                            ...
                                            <td>
                                                ...
                                                <select onchange="jQuery('#<?php echo $this -> pre; ?>billingform').attr('action', '<?php echo $wpcoHtml -> retainquery('updatebilling=1', $wpcoHtml -> bill_url()); ?>').submit();" id="<?php echo $this -> pre; ?>country" class="<?php echo $this -> pre; ?> widefat" name="<?php echo $this -> pre; ?>billing[country]" style="width:100%;">
