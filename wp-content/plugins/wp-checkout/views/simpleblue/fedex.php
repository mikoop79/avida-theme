            	...
            	<?php foreach ($prices as $price) : ?>
                	<?php if (!empty($price -> RatedShipmentDetails[0] -> ShipmentRateDetail -> TotalNetCharge -> Amount)) : ?>
                        <tr class="<?php echo $class = (empty($class) || $class == "erow") ? 'arow' : 'erow'; ?>">
                            ...
                            <td><label for="cu_shippingmethod_<?php echo $price -> ServiceType; ?>"><?php echo $wpcoHtml -> currency_price($price -> RatedShipmentDetails[0] -> ShipmentRateDetail -> TotalNetCharge -> Amount); ?></label></td>
                            <td>
