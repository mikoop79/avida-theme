        ...
        <?php if (empty($options['show']) || $options['show'] == "normal") : ?>
            <ul class="wpco_list">
                    ...
                    <?php if ($this -> get_option('shippingcalc') == "Y" || $this -> get_option('enablecoupons') == "Y" || $this -> get_option('handling') == "Y") : ?>
                        ...
                        <?php if ($this -> get_option('handling') == "Y") : ?>
	                		<?php if ($handling = $Order -> handling($co_id)) : ?>
	                			<li><?php echo __($this -> get_option('handling_title')); ?>: <strong><?php echo $wpcoHtml -> currency_price($handling); ?></strong></li>
	                		<?php endif; ?>
	                	<?php endif; ?>
                ...
                <?php if ($this -> get_option('tax_calculate') == "Y" && !empty($tax_total)) : ?>
                    <li><?php echo $this -> get_option('tax_name'); ?> (<?php echo $wpcoTax -> get_tax_percentage($Order -> do_shipping($co_id)); ?>&#37;): <strong><?php echo $wpcoHtml -> currency_price($tax_total, true, true); ?></strong></li>
                <?php endif; ?>
