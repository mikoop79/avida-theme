    ...
    <?php if ($this -> get_option('product_imagegallery') == "jqzoom" && $this -> is_plugin_active('jqzoom')) : ?>
        ...
        <div class="<?php echo $this -> pre; ?>jqzoom <?php echo $this -> pre; ?>images">
        	<div class="<?php echo $this -> pre; ?>productimage">
                <a href="<?php echo $wpcoHtml -> image_url($product -> image -> name); ?>" title="<?php echo esc_attr(apply_filters($this -> pre . '_product_title', $product -> title)); ?>" class="jqzoom" rel="jqzoom<?php echo $product -> id; ?>">
        ...
        <div class="<?php echo $this -> pre; ?>images">
            <?php if ($this -> get_option('cropthumb') == "Y") : ?>
                ...
                <?php if (file_exists($imagefull) && filesize($imagefull) > 0) : ?>
                    <div class="<?php echo $this -> pre; ?>productimage">
                        <?php echo $wpcoHtml -> link($wpcoHtml -> timthumb_image($product -> image_url, $this -> get_option('thumbw'), $this -> get_option('thumbh'), $this -> get_option('thumbq'), false), $wpcoHtml -> image_url($product -> image -> name), array('class' => "colorbox", 'rel' => $wpcoHtml -> sanitize(apply_filters($this -> pre . '_product_title', $product -> title)) . '-images', 'title' => apply_filters($this -> pre . '_product_title', $product -> title))); ?>
                    </div>
                    <span class="clicktoenlarge"><?php echo $wpcoHtml -> link($wpcocaptions['product']['clicktoenlarge'], $wpcoHtml -> image_url($product -> image -> name), array('class' => "colorbox", 'title' => esc_attr(apply_filters($this -> pre . '_product_title', $product -> title)))); ?></span>
                <?php else : ?>
                        ...
                        <ul>
                            ...
                            <?php foreach ($product -> images as $image) : ?>
                                <?php if ($imgcount <= $this -> get_option('pimgcount')) : ?>
                                    <li><?php echo $wpcoHtml -> link($wpcoHtml -> timthumb_image($image -> image_url, $this -> get_option('smallw'), $this -> get_option('smallh'), $this -> get_option('smallq')), $wpcoHtml -> image_url($image -> filename), array('class' => 'colorbox', 'rel' => $wpcoHtml -> sanitize(apply_filters($this -> pre . '_product_title', $product -> title)) . '-images', 'title' => $image -> title)); ?></li>
                                <?php else : ?>
                                    <?php break; ?>
                                <?php endif; ?>
                                <?php $imgcount++; ?>
                ...
                <?php echo $wpcoHtml -> addtocart_action($product -> id, false); ?>
                    ...
                    <span class="wpcobuttonwrap">
                        <?php if ($this -> get_option('buynow') == "Y" || (!empty($product -> buynow) && $product -> buynow == "Y")) : ?>
                            ...
                            <?php if ($this -> get_option('loop_btntxt') == "txt") : ?>
                                <?php if (!empty($product -> affiliate) && $product -> affiliate == "Y") : ?>
                                    <span id="submit<?php echo $product -> id; ?>" class="productsubmit"><a class="<?php echo $this -> pre; ?>buylink" target="_<?php echo $product -> affiliatewindow; ?>" href="<?php echo $wpcoHtml -> retainquery($this -> pre . 'method=affiliate&amp;id=' . $product -> id); ?>" title="<?php echo apply_filters($this -> pre . '_product_title', $product -> title); ?>"><?php echo $product -> buttontext; ?></a></span>
                                <?php else : ?>
                                    <span id="submit<?php echo $product -> id; ?>" class="productsubmit"><a href="" title="<?php _e('Buy this product now', $this -> plugin_name); ?>" onclick="jQuery('#addtocart<?php echo $product -> id; ?>').submit();" class="<?php echo $this -> pre; ?>buylink"><?php echo $product -> buttontext; ?></a></span>
                                <?php endif; ?>
                            <?php else : ?>
                                <span id="submit<?php echo $product -> id; ?>" class="productsubmit"><?php echo $wpcoForm -> submit($product -> buttontext); ?></span>
                            <?php endif; ?>
                        ...
                        <?php else : ?>
                            ...
                            <?php if ($this -> get_option('loop_btntxt') == "txt") : ?>
                                <?php if (!empty($product -> affiliate) && $product -> affiliate == "Y") : ?>
                                    <span id="submit<?php echo $product -> id; ?>"><a href="<?php echo $wpcoHtml -> retainquery($this -> pre . 'method=affiliate&amp;id=' . $product -> id); ?>" class="<?php echo $this -> pre; ?>buylink" target="_<?php echo $product -> affiliatewindow; ?>" title="<?php echo apply_filters($this -> pre . '_product_title', $product -> title); ?>"><?php echo $product -> buttontext; ?></a></span>
                                <?php else : ?>
                        ...
                        <span class="wpcoloadingwrap" id="wpcoloadingwrap<?php echo $product -> id; ?>" style="display:none;">
	                    	<img src="<?php echo $this -> url(); ?>/views/default/img/loading.gif" alt="loading" />
	                    </span>
								...
								<div id="tabs<?php echo $product -> id; ?>-<?php echo $tabscount; ?>">
									...
									<div>
										...
										<?php if ($this -> get_option('buynow') == "Y" || (!empty($product -> buynow) && $product -> buynow == "Y")) : ?>
											<?php if ($this -> get_option('loop_btntxt') == "txt") : ?>
												<?php if (!empty($product -> affiliate) && $product -> affiliate == "Y") : ?>
													<span id="submit<?php echo $product -> id; ?>"><a class="<?php echo $this -> pre; ?>buylink" target="_<?php echo $product -> affiliatewindow; ?>" href="<?php echo $wpcoHtml -> retainquery($this -> pre . 'method=affiliate&amp;id=' . $product -> id); ?>" title="<?php echo apply_filters($this -> pre . '_product_title', $product -> title); ?>"><?php echo $product -> buttontext; ?></a></span>
												<?php else : ?>
							...
							<div id="tabs<?php echo $product -> id; ?>-<?php echo $tabscount; ?>">
								...
								<div>
									<div class="<?php echo $this -> pre; ?>imglist <?php echo $this -> pre; ?>imglistfull">
										<ul>
											<?php foreach ($product -> images as $image) : ?>
												<li><?php echo $wpcoHtml -> link($wpcoHtml -> timthumb_image($image -> image_url, $this -> get_option('ithumbw'), $this -> get_option('ithumbh'), 100), $wpcoHtml -> image_url($image -> filename), array('class' => 'colorbox', 'rel' => $wpcoHtml -> sanitize(apply_filters($this -> pre . '_product_title', $product -> title)) . '-images', 'title' => $image -> title)); ?></li>
											<?php endforeach; ?>
										</ul>
										<br class="<?php echo $this -> pre; ?>cleaner" />
									</div>
