                	...
                	<?php if (!empty($price -> rate) && $price -> rate != "0.00") : ?>
                        <tr class="<?php echo $class = (empty($class) || $class == "erow") ? 'arow' : 'erow'; ?>">
                            <?php if (!empty($international) && $international == true) : ?>
                                ...
                                <td>
                                    <label for="cu_shipmethod_<?php echo $pkey; ?>"><?php echo $wpcoHtml -> currency_price($price -> rate, true, true); ?></label>
                                </td>
                            <?php else : ?>
                                <td>
                                ...
                                <td><label for="cu_shipmethod_<?php echo $pkey; ?>"><?php echo $wpcoHtml -> currency_price($price -> rate, true, true); ?></label></td>
                            <?php endif; ?>
                        </tr>
                    <?php endif; ?>
                <?php endforeach; ?>
