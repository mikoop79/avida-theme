...
$api_username = "antoni_1306273455_biz_api1.gmail.com";
$api_password = "1306273469";
$api_signature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AIgK3vDJsa.mb3MGFopgdsqhyOdp";
...
<?php if (!empty($order) && !empty($items)) : ?>
	...
	<p>
        <table class="wpco_orderview <?php echo $this -> pre; ?>">
            <tbody>
                <?php $class = ''; ?>
    ...
    <?php if (!empty($order -> cfields)) : ?>
    	...
    	<table class="wpco_orderviewoptions <?php echo $this -> pre; ?> <?php echo $this -> pre; ?>cart">
        	<tbody>
            	<?php $class = false; ?>
	...
	<table class="wpco_orderviewcart <?php echo $this -> pre; ?> <?php echo $this -> pre; ?>cart">
		<thead>
			<tr>
